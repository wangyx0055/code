...
请 ..</p> 
         ...
         --%>
					...
					<div class="hot-list">
						<div class="hot-pane">
							<div class="hot-thumb pull-left">
								<a href=""><img src="../resources/images/hat_icon.gif">
								</a>
							</div>
			...
			<div class="content pull-right" id="serviceDiv">
				...
				<div class="service-list">
					...
					<div class="list">
					 <c:forEach var="s" items="${recommendList}">
						<div class="mini-box">
							<div class="top">
								<a href="service/serviceIntro?sid=${s.sid }" target="_blank"><img width="198" height="131" src="upload/${s.sicon}">
								</a>
							</div>
							<div class="bottom">
								<h3>
									<span class="name pull-left"><a href="service/serviceIntro?sid=${s.sid }" target="_blank">${s.sname }</a></span>
									<span class="num pull-right">¥${s.sprice}</span>
								</h3>
								<p class="btn" align="center">
									<a class="apply-btn" href="javascript:void(0);" data-sid='${s.sid }'
										data-sname='${s.sname }' data-sprice='${s.sprice}'><img
										src="resources/images/apply2_btn.jpg">
									</a>
								</p>
							</div>
						</div>
                ...
                <!-- 每个大类下的服务 -->
                ${ serviceTreeServe}
					 <c:forEach var="parent" items="${serviceTreeServe}">
						<h3 class="title">
							<c:out value="${parent.key.text}" /><a href="service/service_cid?cno=${parent.key.cid}" class="more pull-right" target="_blank">更多</a>
						</h3>
						<div class="list">
							<c:forEach var="child" items="${parent.value}">
								<div class="mini-box">
									<div class="top">
										<a href="service/serviceIntro?sid=${child.sid }" target="_blank"><img src='upload/${child.sicon}'>
										</a>
									</div>
									<div class="bottom">
										<h3>
											<span class="pull-left"><a href="service/serviceIntro?sid=${child.sid }" target="_blank">
													${child.sname}</a>
											</span><span class="num pull-right">${child.sprice}¥</span>
										</h3>
										<p class="btn" align="center">
											<a class="apply-btn" href="javascript:void(0);"
												data-sid='${child.sid }'
												data-sname='${child.sname}'
												data-sprice='${child.sprice}'><img
												src="resources/images/apply2_btn.jpg">
											</a>
										</p>
									</div>
