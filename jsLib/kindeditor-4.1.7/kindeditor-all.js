...
K.options = {
	...
	zIndex : 811213,
	items : [
		'source', '|', 'undo', 'redo', '|', 'preview', 'print', 'temhje', 'code', 'cut', 'copy', 'paste',
...
KindEditor.lang({
	...
	'temhje.selectTemhje' : '可选模板',
	'temhje.replaceContent' : '替换当前内容',
	'temhje.fileList' : {
		'1.html' : '图片和文字',
		'2.html' : '表格',
		'3.html' : '项目编号'
...
KindEditor.plugin('temhje', function(K) {
	var self = this, name = 'temhje', lang = self.lang(name + '.'),
