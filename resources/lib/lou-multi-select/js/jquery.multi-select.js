    ...
    init: function(){
      ...
      if (ms.next('.ms-container').length == 0){
        ...
        var optgroupLabel = null,
            ...
            optgroupCpt = 0,
            scroll = 0,
            optgroupContainerTemhje = '<li class="ms-optgroup-container"></li>',
            optgroupUlTemhje = '<ul class="ms-optgroup"></ul>',
            optgroupLiTemhje = '<li class="ms-optgroup-label"><span></span></li>';
        ...
        ms.find('optgroup, option').each(function(){
          if ($(this).is('optgroup')){
            ...
            var optgroup = $(this),
                optgroupSelectable = $(optgroupContainerTemhje),
                optgroupSelection = $(optgroupContainerTemhje),
                optgroupSelectionLi = $(optgroupLiTemhje),
                optgroupSelectableLi = $(optgroupLiTemhje);
